...
import recycler.ArbabPhoto.photorecoverynew.model.AlbumAudio;
import recycler.ArbabPhoto.photorecoverynew.model.AlbumOthers;
import recycler.ArbabPhoto.photorecoverynew.model.AlbumPhoto;
import recycler.ArbabPhoto.photorecoverynew.model.AlbumVideo;
import recycler.ArbabPhoto.photorecoverynew.model.AudioModel;
import recycler.ArbabPhoto.photorecoverynew.model.OtherModel;
...
public class ScanningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noOfImage = findViewById(R.id.numOf_Image);
        noOfVideo = findViewById(R.id.numOf_Video);
        noOfAudio = findViewById(R.id.numOf_Audio);
        noOfOthers = findViewById(R.id.numOf_Others);
